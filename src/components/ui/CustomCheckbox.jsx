    ...
    return (
        <>
            <label
                ...
                for={`star${props.index}`}
            >
                <input class="peer appearance-none" id={`star${props.index}`} name="star" type="checkbox" />
                <span
                    class="absolute left-0 top-1/2 h-[2em] w-[2em] -translate-x-full -translate-y-1/2 rounded-[0.25em] border-[1px] border-gray-800/30"
                >
                </span>
                <svg
